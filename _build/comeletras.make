...
TARGET = $(TARGETDIR)/comeletras.exe
OBJDIR = obj/x64/Debug/comeletras
...
TARGETDIR = ../_bin/Debug
TARGET = $(TARGETDIR)/comeletras.exe
OBJDIR = obj/x86/Debug/comeletras
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGETDIR = ../_bin/Debug
TARGET = $(TARGETDIR)/comeletras.exe
OBJDIR = obj/ARM64/Debug/comeletras
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGET = $(TARGETDIR)/comeletras.exe
OBJDIR = obj/x64/Release/comeletras
...
TARGETDIR = ../_bin/Release
TARGET = $(TARGETDIR)/comeletras.exe
OBJDIR = obj/x86/Release/comeletras
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGETDIR = ../_bin/Release
TARGET = $(TARGETDIR)/comeletras.exe
OBJDIR = obj/ARM64/Release/comeletras
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
GENERATED += $(OBJDIR)/bounty.o
GENERATED += $(OBJDIR)/commonUtils.o
GENERATED += $(OBJDIR)/font.o
GENERATED += $(OBJDIR)/gameUtils.o
GENERATED += $(OBJDIR)/linkedList.o
GENERATED += $(OBJDIR)/main.o
OBJECTS += $(OBJDIR)/bounty.o
OBJECTS += $(OBJDIR)/commonUtils.o
OBJECTS += $(OBJDIR)/font.o
OBJECTS += $(OBJDIR)/gameUtils.o
...
$(OBJDIR)/bounty.o: ../game/src/bounty/bounty.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/font.o: ../game/src/font.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/main.o: ../game/src/main.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/commonUtils.o: ../game/src/utils/commonUtils.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/gameUtils.o: ../game/src/utils/gameUtils.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/linkedList.o: ../game/src/utils/linkedList.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
